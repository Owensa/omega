...
;(function($,doc,win) 
{
	...
	var booking=function(object,option)
	{
		...
		this.calculateDuration=function(minute)
		{
			...
			return([Math.floor(minute),minute-(Math.floor(minute/60)*60)]);
		};
		...
		this.setData=function()
		{
			...
			data.cost.duration=$this.find('.template-component-booking-package-duration>h5>span:eq(0)').text();
			data.cost.duration=$this.find('.template-component-booking-package-duration>h5>span:eq(2)').text();
